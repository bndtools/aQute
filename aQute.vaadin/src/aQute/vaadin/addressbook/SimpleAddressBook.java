...
/**
 * This example is derived from the SimpleAddressBook example in the
 * Vaadin tutorial: http://vaadin.com/tutorial
 * 
 * The only change necessary was to add the bnd annotation. In this
 * case we use the factory mode of DS to provide a factory id. This
 * id consists of two parts: the class name that will be created as
 * well as the alias. In this case the class name is com.vaadin.Application
 * and the alias is address.
 * 
 */
