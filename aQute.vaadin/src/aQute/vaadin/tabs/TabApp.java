...
/**
 * Demonstrate how you can use services.
 * 
 * This application looks for Component Factory services that have a service
 * property component.factory to com.vaadin.Component/contribution. The first
 * part is a convention to know what classes you are going to create and the
 * second part is a way to not pickup any Component.
 * 
 * Declarative services Component Factory services are used because this model
 * maps very well to the instance based model of Vaadin.
 * 
...
public class TabApp extends Application {
	 ...
	 * 
	 * We need to know when to remove the component so we need a map from the
	 * factory to the instance so that when the factory is unregistered, we can
	 * dispose it.
	 * 
	 * @param factory
