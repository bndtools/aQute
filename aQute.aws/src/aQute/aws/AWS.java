 ...
 * &Message.Body.Text.Data=Hello.%20I%20hope
 * %20you%20are%20having%20a%20good%20day. &Message.Subject.Data=Hello%20Peter
 * &Message.Subject.Data=This%20is%20the%20subject%20line.
 * &Source=ses%40aQute.biz &Source=user%40example.com
 * https://email.us-east-1.amazonaws.com/ ?Action=SendEmail
 * &Source=user%40example.com
 * &Destination.ToAddresses.member.1=allan%40example.com
 * &Message.Subject.Data=This%20is%20the%20subject%20line.
 * &Message.Body.Text.Data
 * =Hello.%20I%20hope%20you%20are%20having%20a%20good%20day.
...
public class AWS {
	...
	public Request request(final Protocol protocol, final String action) throws ParseException {
		return new Request() {
			...
			private HttpURLConnection signVersion2(final Protocol protocol) throws MalformedURLException, IOException {
				...
				for (Map.Entry<String,Object> parameter : arguments.entrySet()) {
					...
					if (value != null) {
						sb.append(del) //
								...
								.append("=")
								//
								.append(encodeUrl(parameter.getValue().toString()));
					}
					del = "&";
				}
				return sb;
